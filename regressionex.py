...
studyHours = 4
student1 = pd.DataFrame([studyHours], columns=['hours'])
pass_prediction = lr.predict(student1)
pass_probability = lr.predict_proba(student1)
print("prediction (0-fail, 1-pass): {}".format(pass_prediction[0]))
